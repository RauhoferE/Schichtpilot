...
public class AdminOnlyWebApplicationFactory : WebApplicationFactory<Schichtpilot.Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.AddAuthentication(options =>
                {
                    options.DefaultAuthenticateScheme = AdminOnlyAuthHandler.SchemeName;
                    options.DefaultChallengeScheme = AdminOnlyAuthHandler.SchemeName;
                })
                .AddScheme<AuthenticationSchemeOptions, AdminOnlyAuthHandler>(
                    AdminOnlyAuthHandler.SchemeName, _ => { });
