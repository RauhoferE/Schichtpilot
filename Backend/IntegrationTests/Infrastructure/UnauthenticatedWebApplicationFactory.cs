...
public class UnauthenticatedWebApplicationFactory : WebApplicationFactory<Schichtpilot.Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.AddAuthentication(options =>
                {
                    options.DefaultAuthenticateScheme = DenyAuthHandler.SchemeName;
                    options.DefaultChallengeScheme = DenyAuthHandler.SchemeName;
                })
                .AddScheme<AuthenticationSchemeOptions, DenyAuthHandler>(
                    DenyAuthHandler.SchemeName, _ => { });
