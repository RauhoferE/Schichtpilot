...
public class UserOnlyWebApplicationFactory : WebApplicationFactory<Schichtpilot.Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            services.AddAuthentication(options =>
                {
                    options.DefaultAuthenticateScheme = UserOnlyAuthHandler.SchemeName;
                    options.DefaultChallengeScheme = UserOnlyAuthHandler.SchemeName;
                })
                .AddScheme<AuthenticationSchemeOptions, UserOnlyAuthHandler>(
                    UserOnlyAuthHandler.SchemeName, _ => { });
